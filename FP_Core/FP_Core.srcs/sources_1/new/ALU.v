...
module ALU (
    ...
    output reg [63:0] alu_full_result
);
    wire [31:0] vfmul_out;
    fp_mult vfmul ( .a(in1), .b(in2), .p(vfmul_out));
    ...
    case(alu_control)
        ...
        4'b0110: alu_result = in1*in2 + 32'd2;
        4'b0111: alu_result = in1^in2;
        4'b1010:  // vedic multiplier
            begin
                alu_result = vfmul_out[31:0];      
                alu_full_result = vfmul_out;       
            end
        default: begin
                alu_result = 32'b0;
                alu_full_result = 64'b0;
         end
